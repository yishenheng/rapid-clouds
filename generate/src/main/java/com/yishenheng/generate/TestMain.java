package com.yishenheng.generate;
...
public class TestMain {
    ...
    private static final String DATASOUORCE_URL = "jdbc:mysql://119.45.47.147:3306/ysh";


    public static void main(String[] args) {

        String[] tables = {"t_contact_info","t_customer_info"};
        String projectName = "/common";
        // 代码生成器
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                // 包配置
                new PackageConfig()
                        .setParent("com.yishenheng.common")// 自定义包路径
